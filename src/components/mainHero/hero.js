    ...
    <section className="relative w-full min-h-svh lg:min-h-[85vh] flex items-center overflow-hidden bg-accent-navy">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 py-20 sm:py-24 lg:py-20">
        <div className="max-w-4xl">
          <div className="bg-accent-navy/55 backdrop-blur-md rounded-3xl p-8 sm:p-10 lg:p-12 border border-footer-text/15 text-left shadow-premium-lg">
            ...
            <p className="text-base sm:text-lg text-footer-text-muted mb-8 leading-relaxed max-w-2xl">
